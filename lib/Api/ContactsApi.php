...
class ContactsApi
{
     ...
     *
     * @param  string $authorization Authorization (required)
     * @param  \Swagger\Client\Model\Contact2 $field_values The record to add (just include the JSON object as the request body) (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    protected function addLinkRequest($id, $authorization, $api_link)
    {
        ...
        $resourcePath = '/v3.0/Contacts/{id}/Links';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getEntitiesByTagRequest($tag_name, $authorization, $brief = 'false', $skip = null, $top = null, $count_total = 'false')
    {
        ...
        $resourcePath = '/Contacts/SearchByTag';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  string $authorization Authorization (required)
     * @param  \Swagger\Client\Model\Contact1 $field_values The record to update (just include the JSON object as the request body) (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\Contact
