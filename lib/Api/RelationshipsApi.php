...
class RelationshipsApi
{
     ...
     * @return object[]
     */
    public function getRelationships($authorization, $skip = null, $top = null, $count_total = 'false')
    {
        list($response) = $this->getRelationshipsWithHttpInfo($authorization, $skip, $top, $count_total);
        return $response;
    }
     ...
     */
    public function getRelationshipsWithHttpInfo($authorization, $skip = null, $top = null, $count_total = 'false')
    {
        $returnType = 'object[]';
        $request = $this->getRelationshipsRequest($authorization, $skip, $top, $count_total);
     ...
     */
    public function getRelationshipsAsync($authorization, $skip = null, $top = null, $count_total = 'false')
    {
        return $this->getRelationshipsAsyncWithHttpInfo($authorization, $skip, $top, $count_total)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getRelationshipsAsyncWithHttpInfo($authorization, $skip = null, $top = null, $count_total = 'false')
    {
        $returnType = 'object[]';
        $request = $this->getRelationshipsRequest($authorization, $skip, $top, $count_total);
     ...
     */
    protected function getRelationshipsRequest($authorization, $skip = null, $top = null, $count_total = 'false')
    {
