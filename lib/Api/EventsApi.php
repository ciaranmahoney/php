...
class EventsApi
{
     ...
     * @param  \Swagger\Client\Model\Event2 $field_values The record to add (just include the JSON object as the request body) (required)
     *
    ...
    protected function addLinkRequest($id, $authorization, $api_link)
    {
        ...
        $resourcePath = '/v3.0/Events/{id}/Links';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  string $authorization Authorization (required)
     * @param  \Swagger\Client\Model\Event1 $field_values The record to update (just include the JSON object as the request body) (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\Event
