...
class LeadsApi
{
     ...
     *
     * @param  string $authorization Authorization (required)
     * @param  \Swagger\Client\Model\Lead2 $field_values The record to add (just include the JSON object as the request body) (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    protected function addLinkRequest($id, $authorization, $api_link)
    {
        ...
        $resourcePath = '/v3.0/Leads/{id}/Links';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteLinkRequest($id, $link_id, $authorization)
    {
        ...
        $resourcePath = '/Leads/{id}/Links/{linkId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getEntitiesByTagRequest($tag_name, $authorization, $brief = 'false', $skip = null, $top = null, $count_total = 'false')
    {
        ...
        $resourcePath = '/Leads/SearchByTag';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  string $authorization Authorization (required)
     * @param  \Swagger\Client\Model\Lead1 $field_values The record to update (just include the JSON object as the request body) (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\Lead
