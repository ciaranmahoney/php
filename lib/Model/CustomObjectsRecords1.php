...
/**
 * CustomObjectsRecords1 Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CustomObjectsRecords1 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CustomObjectsRecords_1';
    ...
    public function setRecordName($record_name)
    {
        if ((strlen($record_name) > 0)) {
            throw new \InvalidArgumentException('invalid length for $record_name when calling CustomObjectsRecords1., must be smaller than or equal to 0.');
        }
    ...
    public function setVisibleTo($visible_to)
    {
        if (!is_null($visible_to) && (strlen($visible_to) > 11)) {
            throw new \InvalidArgumentException('invalid length for $visible_to when calling CustomObjectsRecords1., must be smaller than or equal to 11.');
        }
