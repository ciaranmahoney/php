...
class APIOrganisationDate implements ArrayAccess
{
    ...
    public function setOccasionName($occasion_name)
    {
        if (!is_null($occasion_name) && (strlen($occasion_name) > 128)) {
            throw new \InvalidArgumentException('invalid length for $occasion_name when calling APIOrganisationDate., must be smaller than or equal to 128.');
        }
        if (!is_null($occasion_name) && (strlen($occasion_name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $occasion_name when calling APIOrganisationDate., must be bigger than or equal to 0.');
        }
