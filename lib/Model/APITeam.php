...
class APITeam implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['team_name']) && (strlen($this->container['team_name']) > 255)) {
            $invalid_properties[] = "invalid value for 'team_name', the character length must be smaller than or equal to 255.";
        }

        if (!is_null($this->container['team_name']) && (strlen($this->container['team_name']) < 0)) {
            $invalid_properties[] = "invalid value for 'team_name', the character length must be bigger than or equal to 0.";
        }
    ...
    public function setTeamName($team_name)
    {
        if (!is_null($team_name) && (strlen($team_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $team_name when calling APITeam., must be smaller than or equal to 255.');
        }
        if (!is_null($team_name) && (strlen($team_name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $team_name when calling APITeam., must be bigger than or equal to 0.');
        }
    ...
    /**
     * Sets teammembers
     * @param \Swagger\Client\Model\APITeamMember[] $teammembers
     * @return $this
     */
