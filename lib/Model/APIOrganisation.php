...
class APIOrganisation implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['image_url']) && (strlen($this->container['image_url']) > 500)) {
            $invalid_properties[] = "invalid value for 'image_url', the character length must be smaller than or equal to 500.";
        }
    ...
    public function setImageUrl($image_url)
    {
        if (!is_null($image_url) && (strlen($image_url) > 500)) {
            throw new \InvalidArgumentException('invalid length for $image_url when calling APIOrganisation., must be smaller than or equal to 500.');
        }
        if (!is_null($image_url) && (strlen($image_url) < 0)) {
            throw new \InvalidArgumentException('invalid length for $image_url when calling APIOrganisation., must be bigger than or equal to 0.');
        }
    ...
    /**
     * Sets dates
     * @param \Swagger\Client\Model\APIOrganisationDate[] $dates
     * @return $this
     */
     ...
     * @param \Swagger\Client\Model\APIOrganisationLink[] $organisationlinks
     * @return $this
     */
    ...
    public function setSocialLinkedin($social_linkedin)
    {
        if (!is_null($social_linkedin) && (strlen($social_linkedin) > 255)) {
            throw new \InvalidArgumentException('invalid length for $social_linkedin when calling APIOrganisation., must be smaller than or equal to 255.');
        }
        if (!is_null($social_linkedin) && (strlen($social_linkedin) < 0)) {
            throw new \InvalidArgumentException('invalid length for $social_linkedin when calling APIOrganisation., must be bigger than or equal to 0.');
        }
    ...
    public function setSocialFacebook($social_facebook)
    {
        if (!is_null($social_facebook) && (strlen($social_facebook) > 255)) {
            throw new \InvalidArgumentException('invalid length for $social_facebook when calling APIOrganisation., must be smaller than or equal to 255.');
        }
        if (!is_null($social_facebook) && (strlen($social_facebook) < 0)) {
            throw new \InvalidArgumentException('invalid length for $social_facebook when calling APIOrganisation., must be bigger than or equal to 0.');
        }
    ...
    public function setSocialTwitter($social_twitter)
    {
        if (!is_null($social_twitter) && (strlen($social_twitter) > 255)) {
            throw new \InvalidArgumentException('invalid length for $social_twitter when calling APIOrganisation., must be smaller than or equal to 255.');
        }
        if (!is_null($social_twitter) && (strlen($social_twitter) < 0)) {
            throw new \InvalidArgumentException('invalid length for $social_twitter when calling APIOrganisation., must be bigger than or equal to 0.');
        }
