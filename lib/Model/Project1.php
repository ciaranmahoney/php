 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class Project1 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Project_1';
    ...
    public function setProjectName($project_name)
    {
        if ((strlen($project_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $project_name when calling Project1., must be smaller than or equal to 255.');
        }
    ...
    {
        if ((strlen($status) > 20)) {
            throw new \InvalidArgumentException('invalid length for $status when calling Project1., must be smaller than or equal to 20.');
        }
    ...
    public function setProjectDetails($project_details)
    {
        if (!is_null($project_details) && (strlen($project_details) > 4000)) {
            throw new \InvalidArgumentException('invalid length for $project_details when calling Project1., must be smaller than or equal to 4000.');
        }
    ...
    public function setImageUrl($image_url)
    {
        if (!is_null($image_url) && (strlen($image_url) > 255)) {
            throw new \InvalidArgumentException('invalid length for $image_url when calling Project1., must be smaller than or equal to 255.');
        }
