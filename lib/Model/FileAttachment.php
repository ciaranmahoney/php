...
class FileAttachment implements ArrayAccess
{
    ...
    public function setUrl($url)
    {
        if (!is_null($url) && (strlen($url) > 500)) {
            throw new \InvalidArgumentException('invalid length for $url when calling FileAttachment., must be smaller than or equal to 500.');
        }
        if (!is_null($url) && (strlen($url) < 0)) {
            throw new \InvalidArgumentException('invalid length for $url when calling FileAttachment., must be bigger than or equal to 0.');
        }
