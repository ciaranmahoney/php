...
class ContactInfo implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['label']) && (strlen($this->container['label']) < 0)) {
            $invalid_properties[] = "invalid value for 'label', the character length must be bigger than or equal to 0.";
        }
    ...
    public function setLabel($label)
    {
        if (!is_null($label) && (strlen($label) > 50)) {
            throw new \InvalidArgumentException('invalid length for $label when calling ContactInfo., must be smaller than or equal to 50.');
        }
        if (!is_null($label) && (strlen($label) < 0)) {
            throw new \InvalidArgumentException('invalid length for $label when calling ContactInfo., must be bigger than or equal to 0.');
        }
