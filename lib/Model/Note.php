...
class Note implements ModelInterface, ArrayAccess
{
    ...
    {
        if ((strlen($title) > 255)) {
            throw new \InvalidArgumentException('invalid length for $title when calling Note., must be smaller than or equal to 255.');
        }
    ...
    public function setBody($body)
    {
        if (!is_null($body) && (strlen($body) > 0)) {
            throw new \InvalidArgumentException('invalid length for $body when calling Note., must be smaller than or equal to 0.');
        }
