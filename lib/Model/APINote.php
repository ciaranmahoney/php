...
class APINote implements ArrayAccess
{
    ...
    public function setBody($body)
    {
        if (!is_null($body) && (strlen($body) > 4000)) {
            throw new \InvalidArgumentException('invalid length for $body when calling APINote., must be smaller than or equal to 4000.');
        }
        if (!is_null($body) && (strlen($body) < 0)) {
            throw new \InvalidArgumentException('invalid length for $body when calling APINote., must be bigger than or equal to 0.');
        }
