 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class APINote implements ModelInterface, ArrayAccess
{
    ...
    public function setBody($body)
    {
        if (!is_null($body) && (strlen($body) > 0)) {
            throw new \InvalidArgumentException('invalid length for $body when calling APINote., must be smaller than or equal to 0.');
        }
