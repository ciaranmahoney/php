...
/**
 * Organisation1 Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class Organisation1 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Organisation_1';
    ...
    public function setOrganisationName($organisation_name)
    {
        if ((strlen($organisation_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $organisation_name when calling Organisation1., must be smaller than or equal to 255.');
        }
    ...
    public function setBackground($background)
    {
        if (!is_null($background) && (strlen($background) > 4000)) {
            throw new \InvalidArgumentException('invalid length for $background when calling Organisation1., must be smaller than or equal to 4000.');
        }
    ...
    public function setImageUrl($image_url)
    {
        if (!is_null($image_url) && (strlen($image_url) > 500)) {
            throw new \InvalidArgumentException('invalid length for $image_url when calling Organisation1., must be smaller than or equal to 500.');
        }
    ...
    public function setPhone($phone)
    {
        if (!is_null($phone) && (strlen($phone) > 255)) {
            throw new \InvalidArgumentException('invalid length for $phone when calling Organisation1., must be smaller than or equal to 255.');
        }
    ...
    public function setPhoneFax($phone_fax)
    {
        if (!is_null($phone_fax) && (strlen($phone_fax) > 255)) {
            throw new \InvalidArgumentException('invalid length for $phone_fax when calling Organisation1., must be smaller than or equal to 255.');
        }
    ...
    public function setWebsite($website)
    {
        if (!is_null($website) && (strlen($website) > 255)) {
            throw new \InvalidArgumentException('invalid length for $website when calling Organisation1., must be smaller than or equal to 255.');
        }
    ...
    public function setAddressBillingStreet($address_billing_street)
    {
        if (!is_null($address_billing_street) && (strlen($address_billing_street) > 255)) {
            throw new \InvalidArgumentException('invalid length for $address_billing_street when calling Organisation1., must be smaller than or equal to 255.');
        }
    ...
    public function setAddressBillingCity($address_billing_city)
    {
        if (!is_null($address_billing_city) && (strlen($address_billing_city) > 255)) {
            throw new \InvalidArgumentException('invalid length for $address_billing_city when calling Organisation1., must be smaller than or equal to 255.');
        }
    ...
    public function setAddressBillingState($address_billing_state)
    {
        if (!is_null($address_billing_state) && (strlen($address_billing_state) > 255)) {
            throw new \InvalidArgumentException('invalid length for $address_billing_state when calling Organisation1., must be smaller than or equal to 255.');
        }
    ...
    public function setAddressBillingCountry($address_billing_country)
    {
        if (!is_null($address_billing_country) && (strlen($address_billing_country) > 255)) {
            throw new \InvalidArgumentException('invalid length for $address_billing_country when calling Organisation1., must be smaller than or equal to 255.');
        }
    ...
    public function setAddressBillingPostcode($address_billing_postcode)
    {
        if (!is_null($address_billing_postcode) && (strlen($address_billing_postcode) > 255)) {
            throw new \InvalidArgumentException('invalid length for $address_billing_postcode when calling Organisation1., must be smaller than or equal to 255.');
        }
    ...
    public function setAddressShipStreet($address_ship_street)
    {
        if (!is_null($address_ship_street) && (strlen($address_ship_street) > 255)) {
            throw new \InvalidArgumentException('invalid length for $address_ship_street when calling Organisation1., must be smaller than or equal to 255.');
        }
    ...
    public function setAddressShipCity($address_ship_city)
    {
        if (!is_null($address_ship_city) && (strlen($address_ship_city) > 255)) {
            throw new \InvalidArgumentException('invalid length for $address_ship_city when calling Organisation1., must be smaller than or equal to 255.');
        }
    ...
    public function setAddressShipState($address_ship_state)
    {
        if (!is_null($address_ship_state) && (strlen($address_ship_state) > 255)) {
            throw new \InvalidArgumentException('invalid length for $address_ship_state when calling Organisation1., must be smaller than or equal to 255.');
        }
    ...
    public function setAddressShipPostcode($address_ship_postcode)
    {
        if (!is_null($address_ship_postcode) && (strlen($address_ship_postcode) > 255)) {
            throw new \InvalidArgumentException('invalid length for $address_ship_postcode when calling Organisation1., must be smaller than or equal to 255.');
        }
    ...
    public function setAddressShipCountry($address_ship_country)
    {
        if (!is_null($address_ship_country) && (strlen($address_ship_country) > 255)) {
            throw new \InvalidArgumentException('invalid length for $address_ship_country when calling Organisation1., must be smaller than or equal to 255.');
        }
    ...
    public function setSocialLinkedin($social_linkedin)
    {
        if (!is_null($social_linkedin) && (strlen($social_linkedin) > 255)) {
            throw new \InvalidArgumentException('invalid length for $social_linkedin when calling Organisation1., must be smaller than or equal to 255.');
        }
    ...
    public function setSocialFacebook($social_facebook)
    {
        if (!is_null($social_facebook) && (strlen($social_facebook) > 255)) {
            throw new \InvalidArgumentException('invalid length for $social_facebook when calling Organisation1., must be smaller than or equal to 255.');
        }
    ...
    public function setSocialTwitter($social_twitter)
    {
        if (!is_null($social_twitter) && (strlen($social_twitter) > 255)) {
            throw new \InvalidArgumentException('invalid length for $social_twitter when calling Organisation1., must be smaller than or equal to 255.');
        }
