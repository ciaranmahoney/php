 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class Contact1 implements ModelInterface, ArrayAccess
{
    ...
    public function setSalutation($salutation)
    {
        if (!is_null($salutation) && (strlen($salutation) > 50)) {
            throw new \InvalidArgumentException('invalid length for $salutation when calling Contact1., must be smaller than or equal to 50.');
        }
    ...
    public function setFirstName($first_name)
    {
        if ((strlen($first_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling Contact1., must be smaller than or equal to 255.');
        }
    ...
    public function setLastName($last_name)
    {
        if (!is_null($last_name) && (strlen($last_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling Contact1., must be smaller than or equal to 255.');
        }
    ...
    public function setBackground($background)
    {
        if (!is_null($background) && (strlen($background) > 4000)) {
            throw new \InvalidArgumentException('invalid length for $background when calling Contact1., must be smaller than or equal to 4000.');
        }
    ...
    public function setSocialLinkedin($social_linkedin)
    {
        if (!is_null($social_linkedin) && (strlen($social_linkedin) > 255)) {
            throw new \InvalidArgumentException('invalid length for $social_linkedin when calling Contact1., must be smaller than or equal to 255.');
        }
    ...
    public function setSocialFacebook($social_facebook)
    {
        if (!is_null($social_facebook) && (strlen($social_facebook) > 255)) {
            throw new \InvalidArgumentException('invalid length for $social_facebook when calling Contact1., must be smaller than or equal to 255.');
        }
    ...
    public function setSocialTwitter($social_twitter)
    {
        if (!is_null($social_twitter) && (strlen($social_twitter) > 255)) {
            throw new \InvalidArgumentException('invalid length for $social_twitter when calling Contact1., must be smaller than or equal to 255.');
        }
    ...
    public function setPhone($phone)
    {
        if (!is_null($phone) && (strlen($phone) > 255)) {
            throw new \InvalidArgumentException('invalid length for $phone when calling Contact1., must be smaller than or equal to 255.');
        }
    ...
    public function setPhoneHome($phone_home)
    {
        if (!is_null($phone_home) && (strlen($phone_home) > 255)) {
            throw new \InvalidArgumentException('invalid length for $phone_home when calling Contact1., must be smaller than or equal to 255.');
        }
    ...
    public function setPhoneMobile($phone_mobile)
    {
        if (!is_null($phone_mobile) && (strlen($phone_mobile) > 255)) {
            throw new \InvalidArgumentException('invalid length for $phone_mobile when calling Contact1., must be smaller than or equal to 255.');
        }
    ...
    public function setPhoneOther($phone_other)
    {
        if (!is_null($phone_other) && (strlen($phone_other) > 255)) {
            throw new \InvalidArgumentException('invalid length for $phone_other when calling Contact1., must be smaller than or equal to 255.');
        }
    ...
    public function setPhoneAssistant($phone_assistant)
    {
        if (!is_null($phone_assistant) && (strlen($phone_assistant) > 255)) {
            throw new \InvalidArgumentException('invalid length for $phone_assistant when calling Contact1., must be smaller than or equal to 255.');
        }
    ...
    public function setPhoneFax($phone_fax)
    {
        if (!is_null($phone_fax) && (strlen($phone_fax) > 255)) {
            throw new \InvalidArgumentException('invalid length for $phone_fax when calling Contact1., must be smaller than or equal to 255.');
        }
    ...
    public function setEmailAddress($email_address)
    {
        if (!is_null($email_address) && (strlen($email_address) > 255)) {
            throw new \InvalidArgumentException('invalid length for $email_address when calling Contact1., must be smaller than or equal to 255.');
        }
    ...
    public function setAssistantName($assistant_name)
    {
        if (!is_null($assistant_name) && (strlen($assistant_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $assistant_name when calling Contact1., must be smaller than or equal to 255.');
        }
    ...
    public function setAddressMailStreet($address_mail_street)
    {
        if (!is_null($address_mail_street) && (strlen($address_mail_street) > 255)) {
            throw new \InvalidArgumentException('invalid length for $address_mail_street when calling Contact1., must be smaller than or equal to 255.');
        }
    ...
    public function setAddressMailCity($address_mail_city)
    {
        if (!is_null($address_mail_city) && (strlen($address_mail_city) > 255)) {
            throw new \InvalidArgumentException('invalid length for $address_mail_city when calling Contact1., must be smaller than or equal to 255.');
        }
    ...
    public function setAddressMailState($address_mail_state)
    {
        if (!is_null($address_mail_state) && (strlen($address_mail_state) > 255)) {
            throw new \InvalidArgumentException('invalid length for $address_mail_state when calling Contact1., must be smaller than or equal to 255.');
        }
    ...
    public function setAddressMailPostcode($address_mail_postcode)
    {
        if (!is_null($address_mail_postcode) && (strlen($address_mail_postcode) > 128)) {
            throw new \InvalidArgumentException('invalid length for $address_mail_postcode when calling Contact1., must be smaller than or equal to 128.');
        }
    ...
    public function setAddressMailCountry($address_mail_country)
    {
        if (!is_null($address_mail_country) && (strlen($address_mail_country) > 255)) {
            throw new \InvalidArgumentException('invalid length for $address_mail_country when calling Contact1., must be smaller than or equal to 255.');
        }
    ...
    public function setAddressOtherStreet($address_other_street)
    {
        if (!is_null($address_other_street) && (strlen($address_other_street) > 255)) {
            throw new \InvalidArgumentException('invalid length for $address_other_street when calling Contact1., must be smaller than or equal to 255.');
        }
    ...
    public function setAddressOtherCity($address_other_city)
    {
        if (!is_null($address_other_city) && (strlen($address_other_city) > 255)) {
            throw new \InvalidArgumentException('invalid length for $address_other_city when calling Contact1., must be smaller than or equal to 255.');
        }
    ...
    public function setAddressOtherState($address_other_state)
    {
        if (!is_null($address_other_state) && (strlen($address_other_state) > 255)) {
            throw new \InvalidArgumentException('invalid length for $address_other_state when calling Contact1., must be smaller than or equal to 255.');
        }
    ...
    public function setAddressOtherPostcode($address_other_postcode)
    {
        if (!is_null($address_other_postcode) && (strlen($address_other_postcode) > 128)) {
            throw new \InvalidArgumentException('invalid length for $address_other_postcode when calling Contact1., must be smaller than or equal to 128.');
        }
    ...
    public function setAddressOtherCountry($address_other_country)
    {
        if (!is_null($address_other_country) && (strlen($address_other_country) > 255)) {
            throw new \InvalidArgumentException('invalid length for $address_other_country when calling Contact1., must be smaller than or equal to 255.');
        }
    ...
    public function setTitle($title)
    {
        if (!is_null($title) && (strlen($title) > 255)) {
            throw new \InvalidArgumentException('invalid length for $title when calling Contact1., must be smaller than or equal to 255.');
        }
