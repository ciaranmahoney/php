...
class Organisation implements ArrayAccess
{
    ...
    public function setImageUrl($image_url)
    {
        ...
        if (!is_null($image_url) && (strlen($image_url) < 0)) {
            throw new \InvalidArgumentException('invalid length for $image_url when calling Organisation., must be bigger than or equal to 0.');
        }
    ...
    public function setSocialLinkedin($social_linkedin)
    {
        ...
        if (!is_null($social_linkedin) && (strlen($social_linkedin) < 0)) {
            throw new \InvalidArgumentException('invalid length for $social_linkedin when calling Organisation., must be bigger than or equal to 0.');
        }
    ...
    public function setSocialFacebook($social_facebook)
    {
        ...
        if (!is_null($social_facebook) && (strlen($social_facebook) < 0)) {
            throw new \InvalidArgumentException('invalid length for $social_facebook when calling Organisation., must be bigger than or equal to 0.');
        }
    ...
    public function setSocialTwitter($social_twitter)
    {
        ...
        if (!is_null($social_twitter) && (strlen($social_twitter) < 0)) {
            throw new \InvalidArgumentException('invalid length for $social_twitter when calling Organisation., must be bigger than or equal to 0.');
        }
