...
class Event1 implements ModelInterface, ArrayAccess
{
    ...
    public function setTitle($title)
    {
        if (!is_null($title) && (strlen($title) > 255)) {
            throw new \InvalidArgumentException('invalid length for $title when calling Event1., must be smaller than or equal to 255.');
        }
    ...
    public function setLocation($location)
    {
        if (!is_null($location) && (strlen($location) > 255)) {
            throw new \InvalidArgumentException('invalid length for $location when calling Event1., must be smaller than or equal to 255.');
        }
    ...
    public function setDetails($details)
    {
        if (!is_null($details) && (strlen($details) > 4000)) {
            throw new \InvalidArgumentException('invalid length for $details when calling Event1., must be smaller than or equal to 4000.');
        }
