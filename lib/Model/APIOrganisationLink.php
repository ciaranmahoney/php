...
class APIOrganisationLink implements ArrayAccess
{
    ...
    public function setDetails($details)
    {
        if (!is_null($details) && (strlen($details) > 255)) {
            throw new \InvalidArgumentException('invalid length for $details when calling APIOrganisationLink., must be smaller than or equal to 255.');
        }
        if (!is_null($details) && (strlen($details) < 0)) {
            throw new \InvalidArgumentException('invalid length for $details when calling APIOrganisationLink., must be bigger than or equal to 0.');
        }
