 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class Event2 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Event_2';
    ...
    public function setTitle($title)
    {
        if (!is_null($title) && (strlen($title) > 255)) {
            throw new \InvalidArgumentException('invalid length for $title when calling Event2., must be smaller than or equal to 255.');
        }
    ...
    public function setLocation($location)
    {
        if (!is_null($location) && (strlen($location) > 255)) {
            throw new \InvalidArgumentException('invalid length for $location when calling Event2., must be smaller than or equal to 255.');
        }
    ...
    public function setDetails($details)
    {
        if (!is_null($details) && (strlen($details) > 4000)) {
            throw new \InvalidArgumentException('invalid length for $details when calling Event2., must be smaller than or equal to 4000.');
        }
