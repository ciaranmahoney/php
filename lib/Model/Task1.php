 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class Task1 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Task_1';
    ...
    {
        if ((strlen($title) > 500)) {
            throw new \InvalidArgumentException('invalid length for $title when calling Task1., must be smaller than or equal to 500.');
        }
    ...
    public function setDetails($details)
    {
        if (!is_null($details) && (strlen($details) > 4000)) {
            throw new \InvalidArgumentException('invalid length for $details when calling Task1., must be smaller than or equal to 4000.');
        }
    ...
    public function setStatus($status)
    {
        if (!is_null($status) && (strlen($status) > 20)) {
            throw new \InvalidArgumentException('invalid length for $status when calling Task1., must be smaller than or equal to 20.');
        }
    ...
    public function setRecurrence($recurrence)
    {
        if (!is_null($recurrence) && (strlen($recurrence) > 20)) {
            throw new \InvalidArgumentException('invalid length for $recurrence when calling Task1., must be smaller than or equal to 20.');
        }
