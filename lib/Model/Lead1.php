 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class Lead1 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Lead_1';
    ...
    public function setSalutation($salutation)
    {
        if (!is_null($salutation) && (strlen($salutation) > 50)) {
            throw new \InvalidArgumentException('invalid length for $salutation when calling Lead1., must be smaller than or equal to 50.');
        }
    ...
    public function setFirstName($first_name)
    {
        if (!is_null($first_name) && (strlen($first_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling Lead1., must be smaller than or equal to 255.');
        }
    ...
    public function setLastName($last_name)
    {
        if ((strlen($last_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling Lead1., must be smaller than or equal to 255.');
        }
    ...
    public function setTitle($title)
    {
        if (!is_null($title) && (strlen($title) > 255)) {
            throw new \InvalidArgumentException('invalid length for $title when calling Lead1., must be smaller than or equal to 255.');
        }
    ...
    public function setEmail($email)
    {
        if (!is_null($email) && (strlen($email) > 255)) {
            throw new \InvalidArgumentException('invalid length for $email when calling Lead1., must be smaller than or equal to 255.');
        }
    ...
    public function setFax($fax)
    {
        if (!is_null($fax) && (strlen($fax) > 255)) {
            throw new \InvalidArgumentException('invalid length for $fax when calling Lead1., must be smaller than or equal to 255.');
        }
    ...
    public function setIndustry($industry)
    {
        if (!is_null($industry) && (strlen($industry) > 128)) {
            throw new \InvalidArgumentException('invalid length for $industry when calling Lead1., must be smaller than or equal to 128.');
        }
    ...
    public function setLeadDescription($lead_description)
    {
        if (!is_null($lead_description) && (strlen($lead_description) > 4000)) {
            throw new \InvalidArgumentException('invalid length for $lead_description when calling Lead1., must be smaller than or equal to 4000.');
        }
    ...
    public function setMobile($mobile)
    {
        if (!is_null($mobile) && (strlen($mobile) > 255)) {
            throw new \InvalidArgumentException('invalid length for $mobile when calling Lead1., must be smaller than or equal to 255.');
        }
    ...
    public function setPhone($phone)
    {
        if (!is_null($phone) && (strlen($phone) > 255)) {
            throw new \InvalidArgumentException('invalid length for $phone when calling Lead1., must be smaller than or equal to 255.');
        }
    ...
    public function setWebsite($website)
    {
        if (!is_null($website) && (strlen($website) > 255)) {
            throw new \InvalidArgumentException('invalid length for $website when calling Lead1., must be smaller than or equal to 255.');
        }
    ...
    public function setAddressStreet($address_street)
    {
        if (!is_null($address_street) && (strlen($address_street) > 255)) {
            throw new \InvalidArgumentException('invalid length for $address_street when calling Lead1., must be smaller than or equal to 255.');
        }
    ...
    public function setAddressCity($address_city)
    {
        if (!is_null($address_city) && (strlen($address_city) > 255)) {
            throw new \InvalidArgumentException('invalid length for $address_city when calling Lead1., must be smaller than or equal to 255.');
        }
    ...
    public function setAddressState($address_state)
    {
        if (!is_null($address_state) && (strlen($address_state) > 255)) {
            throw new \InvalidArgumentException('invalid length for $address_state when calling Lead1., must be smaller than or equal to 255.');
        }
    ...
    public function setAddressPostcode($address_postcode)
    {
        if (!is_null($address_postcode) && (strlen($address_postcode) > 128)) {
            throw new \InvalidArgumentException('invalid length for $address_postcode when calling Lead1., must be smaller than or equal to 128.');
        }
    ...
    public function setAddressCountry($address_country)
    {
        if (!is_null($address_country) && (strlen($address_country) > 255)) {
            throw new \InvalidArgumentException('invalid length for $address_country when calling Lead1., must be smaller than or equal to 255.');
        }
    ...
    public function setOrganisationName($organisation_name)
    {
        if (!is_null($organisation_name) && (strlen($organisation_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $organisation_name when calling Lead1., must be smaller than or equal to 255.');
        }
