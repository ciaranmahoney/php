...
# **addEntity**
> \Swagger\Client\Model\Task addEntity($authorization, $field_values)
...
$authorization = "{{Authorization}}"; // string | Authorization
$field_values = new \Swagger\Client\Model\Task2(); // \Swagger\Client\Model\Task2 | The record to add (just include the JSON object as the request body)
...
------------- | ------------- | ------------- | -------------
 **authorization** | **string**| Authorization | [default to {{Authorization}}]
 **field_values** | [**\Swagger\Client\Model\Task2**](../Model/Task2.md)| The record to add (just include the JSON object as the request body) |
...
# **getEntity**
> \Swagger\Client\Model\Task getEntity($id, $authorization)
...
# **updateEntity**
> \Swagger\Client\Model\Task updateEntity($authorization, $field_values)
...
$authorization = "{{Authorization}}"; // string | Authorization
$field_values = new \Swagger\Client\Model\Task1(); // \Swagger\Client\Model\Task1 | The record to update (just include the JSON object as the request body)
...
------------- | ------------- | ------------- | -------------
 **authorization** | **string**| Authorization | [default to {{Authorization}}]
 **field_values** | [**\Swagger\Client\Model\Task1**](../Model/Task1.md)| The record to update (just include the JSON object as the request body) |
